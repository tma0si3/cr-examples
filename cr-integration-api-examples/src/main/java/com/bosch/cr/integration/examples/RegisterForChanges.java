 ...
 * handlers to be informed about {@link com.bosch.cr.integration.things.ThingLifecycleChange}s and
...
public final class RegisterForChanges extends ExamplesBase
{
   ...
   public void registerForLifecycleChanges()
   {
      ...
      thingIntegration.registerForLifecycleChange(ALL_THINGS_LIFECYCLE, lifecycle -> LOGGER.info("lifecycle received: {}", lifecycle));

      /* Register for *all* lifecycle events of a *specific* thing */
      myThing.registerForLifecycleChange(MY_THING_LIFECYCLE, lifecycleEvent -> LOGGER.info("lifecycle received: {}", lifecycleEvent));
   }
